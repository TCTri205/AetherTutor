    ...
    <div className="flex flex-col gap-10 max-w-7xl mx-auto">
      ...
      <section className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="space-y-2">
          <h2 className="text-4xl font-bold text-primary tracking-tight">Chào buổi sáng, Tutor</h2>
          <p className="text-secondary text-lg">Hôm nay bạn muốn khám phá tri thức từ tài liệu nào?</p>
        </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-gradient-to-br from-blue-500/10 to-transparent border-primary/10">
          ...
          <CardContent>
            ...
            <p className="text-xs text-secondary mt-1">Đã được tải lên hệ thống</p>
          </CardContent>
        </Card>
        <Card className="bg-gradient-to-br from-emerald-500/10 to-transparent border-emerald-500/10">
          ...
          <CardContent>
            ...
            <p className="text-xs text-secondary mt-1">Đã được định danh trong đồ thị</p>
          </CardContent>
        </Card>
        <Card className="bg-gradient-to-br from-purple-500/10 to-transparent border-purple-500/10">
          ...
          <CardContent>
            ...
            <p className="text-xs text-secondary mt-1">Các kết nối tri thức được tìm thấy</p>
          </CardContent>
        </Card>
      </section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <section className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 gap-4">
            {recentDocs.length > 0 ? (
                  ...
                  <CardContent className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-xl bg-secondary flex items-center justify-center group-hover:bg-primary/10 transition-colors">
                        <FileText className="w-6 h-6 text-secondary group-hover:text-primary transition-colors" />
                      </div>
                      <div className="flex flex-col">
                        <span className="font-bold text-primary truncate max-w-[200px] md:max-w-md">{doc.filename}</span>
              ...
              <div className="flex flex-col items-center justify-center py-20 glass rounded-3xl border-dashed border-border-primary gap-4 text-center">
                <div className="w-16 h-16 rounded-full bg-secondary flex items-center justify-center">
                  <FileText className="w-8 h-8 text-tertiary" />
                </div>
                <p className="text-secondary">Chưa có tài liệu nào. Hãy bắt đầu bằng cách tải lên một tệp PDF.</p>
        ...
        <section className="space-y-6">
          ...
          <div className="flex flex-col gap-4">
             <Button variant="secondary" className="justify-start h-auto p-4 rounded-2xl gap-4 bg-secondary hover:bg-tertiary transition-all border border-border-primary overflow-hidden relative group" onClick={() => navigate('/chat')}>
                ...
                <div className="flex flex-col items-start">
                   <span className="font-bold text-primary">Bắt đầu hội thoại</span>
                   <span className="text-xs text-secondary">Đặt câu hỏi cho Socratic Tutor</span>
                </div>
             </Button>

             <Button variant="secondary" className="justify-start h-auto p-4 rounded-2xl gap-4 bg-secondary hover:bg-tertiary transition-all border border-border-primary overflow-hidden relative group" onClick={() => navigate('/graph')}>
                ...
                <div className="flex flex-col items-start">
                   <span className="font-bold text-primary">Khám phá đồ thị</span>
                   <span className="text-xs text-secondary">Xem trực quan các kết nối tri thức</span>
                </div>
             </Button>
          </div>
        </section>
